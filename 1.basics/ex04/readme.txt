...
01. webpack은 작게 분리된 많은 어플리케이션 모듈(js, css, images, font)들을 '의존성 분석'하여 하나의 JS 파일로 묶는 도구
...
04. 빌드 작업(js 모듈)
    ...
    4) 난독화/압축(uglify) 작업
    5) 번들링
05. JS 모듈뿐만 아니라 다양한 애셋(자원)(images, css, sass/scss, font)들도 모듈로 취급한다.
06. 설치
